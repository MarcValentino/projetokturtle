...
QT_MOC_LITERAL(1, 12, 22), // "currentlySelectedError"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 6), // "enable"
QT_MOC_LITERAL(4, 43, 7), // "disable"
QT_MOC_LITERAL(5, 51, 25), // "selectedErrorChangedProxy"
QT_MOC_LITERAL(6, 77, 13) // "helpRequested"

    },
    "ErrorDialog\0currentlySelectedError\0\0"
    "enable\0disable\0selectedErrorChangedProxy\0"
    "helpRequested"
};
...
void ErrorDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->currentlySelectedError((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3])),(*reinterpret_cast< int(*)>(_a[4]))); break;
        case 1: _t->enable(); break;
        case 2: _t->disable(); break;
        case 3: _t->selectedErrorChangedProxy(); break;
        case 4: _t->helpRequested(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (ErrorDialog::*_t)(int , int , int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ErrorDialog::currentlySelectedError)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ErrorDialog::currentlySelectedError(int _t1, int _t2, int _t3, int _t4)
{
